...
export default function Footer() {
  return (
    <footer className="bg-background text-foreground/80 relative">
      {/* subtle accent line */}
      <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-primary/40 via-accent/30 to-primary/40" />
